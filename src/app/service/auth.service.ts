...
export class AuthService {
  ...
  deleteQuiz(id) {
    return this.http.post(this.url + '/apis/deleteQuiz', { id }, { headers: this.headers });
  }

  getQuizById(id) {
    return this.http.post(this.url + '/apis/getQuizById', { id }, { headers: this.headers });
  }

  saveResponse(id, response) {
    return this.http.post(this.url + '/apis/saveResponse', { id, response }, { headers: this.headers });
  }
